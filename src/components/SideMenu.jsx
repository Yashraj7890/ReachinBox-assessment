                ...
                {loading ? (<div className={` text-[1.5rem] text-center mt-[1.5rem] ${isDarkMode ? 'text-white' : 'text-black '}`}><i className="fa-solid fa-spinner fa-spin"></i></div>)
                            ...
                            <div className='flex-1 overflow-y-auto '>
                                ...
                                <div className='mb-[0.3rem] mt-[0.7rem]'>
                                    ...
                                    <i class="fa-solid fa-circle pr-[0.4rem] text-[10px]"></i>Status</span>
                                    <span className={`pt-[2.5px] pb-[3px] px-[12px] text-center ml-[0.5rem] ${isDarkMode ? 'bg-[#1F1F1F]' : 'bg-[#f3f3f3] text-[#545454] '} rounded-xl font-bold`}><i className="fa-solid fa-paper-plane pr-[0.4rem]"></i>Campaign Name</span>
                                    </div>
                                </div>
